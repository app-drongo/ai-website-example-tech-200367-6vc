...
export default function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/exampletech' },
    { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/exampletech' },
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/exampletech' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/exampletech' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/exampletech' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                development tools. Join thousands of engineering teams who rely on our scalable
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">engineering@exampletech.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get technical updates, new features, and developer resources. Unsubscribe anytime.
              </p>
            </div>
          </div>
