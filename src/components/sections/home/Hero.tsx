...
export default function Hero({
  ...
  titleHighlight = 'Example Tech Solutions',
  description = 'Accelerate your development with our cutting-edge platform. Deploy scalable applications faster with enterprise-grade security and performance.',
  features = [
  ...
  imageAlt = 'Example Tech Dashboard',
